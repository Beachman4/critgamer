...
var _UserIndex = require('./components/admin/UserIndex.vue');

var _UserIndex2 = _interopRequireDefault(_UserIndex);

var _UserView = require('./components/admin/UserView.vue');
...
_vue2.default.component('user-index', _UserIndex2.default);
_vue2.default.component('user-view', _UserView2.default);
var vm = new _vue2.default({
    el: 'body'
});

},{"./components/admin/UserIndex.vue":18,"./components/admin/UserView.vue":19,"bootstrap":1,"vue":16,"vue-resource":15}],18:[function(require,module,exports){
"use strict";
    ...
    methods: {
        fetchUsers: function fetchUsers() {
            ...
            this.$http.get('/api/admin/users').then(function (response) {
                _this.users = response.json().users;
            });
        }
    }
};
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-7a79481d", module.exports)
  } else {
    hotAPI.update("_v-7a79481d", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
exports.default = {
    ...
    methods: {
        fetchUser: function fetchUser() {
            ...
            this.$http.get('/api/admin/users/' + this.id).then(function (response) {
        ...
        submitData: function submitData() {
            ...
            this.$http.post('/api/admin/users/' + this.id, this.user).then(function (response) {
                _this2.edit = false;
            });
        }
    }
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-0264eaaa", module.exports)
  } else {
    hotAPI.update("_v-0264eaaa", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"vue":16,"vue-hot-reload-api":14}]},{},[17]);

//# sourceMappingURL=adminVue.js.map
