...
exports.default = {
    ...
    methods: {
        loadStuff: function loadStuff() {
            ...
            $.when($.getScript("/assets/js/jquery.mousewheel.min.js"), $.getScript("/assets/js/jquery.simplr.smoothscroll.min.js"), $.getScript("https://code.jquery.com/mobile/1.4.5/jquery.mobile-1.4.5.min.js"), $.getScript("https://rawgit.com/pixedelic/Camera/master/scripts/jquery.easing.1.3.js"), $.getScript("https://rawgit.com/pixedelic/Camera/master/scripts/camera.min.js"), $.getScript("/assets/js/jquery.rd-parallax.js"), $.Deferred(function (deferred) {
                $(deferred.resolve);
            })).done(function () {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-afd350be", module.exports)
  } else {
    hotAPI.update("_v-afd350be", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
},{"vue":17,"vue-hot-reload-api":14,"vueify/lib/insert-css":18}],24:[function(require,module,exports){
"use strict";
...
var _UserBar = require('./components/UserBar.vue');
